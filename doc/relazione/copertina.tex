\begin{titlepage}
    \begin{center}
        ...
        \hfil{
            \halign{
                \strut # & \hspace{6cm} #\cr
                \hspace{1cm}\textbf{Studente:} & \textbf{Professori:}\hspace{1cm}\cr
                \hspace{1cm}\textit{Diego Russo - 231423} & \textit{Antonio Lagan\`{a}}\hspace{1cm}\cr
                \hspace{1cm}me@diegor.it & \textit{Leonardo Pacifici}\hspace{1cm}\cr
            }
        }\hfil
